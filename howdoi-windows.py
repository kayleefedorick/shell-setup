...
def main():
    ...
    interpreter.system_message =           """You are a 'how do I' command running in a Linux terminal. 
                                           You have vast knowledge of Windows, Linux and other IT and computing topics.
                                           You mainly provide information on Windows, but the system you are running on is:
                                           Linux Mint 22.04, 
                                           Shell: zsh,
                                           Editor: micro,
                                           User: kaylee
    ...
    interpreter.chat(f"""How do I {question} on Windows 11 21H2? 
